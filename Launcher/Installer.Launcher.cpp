...
int wmain(int argc, wchar_t* argv[])
{
	...
	{
		SetProcessDPIAware();
		auto ok = MessageBox(NULL, L"Installer files not found.\r\nWould you like to download it now?\r\nhttps://github.com/Night-GUA/YuET-Installer/", L"YuET-Installer", MB_ICONWARNING | MB_OKCANCEL);
		if (ok == IDOK)
		{
			ShellExecute(NULL, NULL, L"https://github.com/Night-GUA/YuET-Installer/releases", NULL, NULL, SW_SHOWNORMAL);
		}
	}
}
